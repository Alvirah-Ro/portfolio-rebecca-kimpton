            ...
            <div className="row">
                <div className="col my-5">
                    ...
                    <div>
                        ...
                        <p>Completed coursework covering front-end and back-end development, cloud computing, and DevOps.</p>
                        ...
                        <ul>
                            ...
                            <li>Django Application Development with SQL and Databases</li>
                            <li>Introduction to Containers with Docker, Kubernetes & OpenShift</li>
